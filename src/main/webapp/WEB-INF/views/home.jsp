                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="header-navbar">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="hidden-xs" style="position: absolute;right: 0px;"><a href="/user"><span class="glyphicon glyphicon-user"></span> {{login_user}}</a></li>
                                        <li class="visible-xs-block"><a href="/user"><span class="glyphicon glyphicon-user"></span> {{login_user}}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
